...
chmod 644 "$APP_DIR/Contents/Resources/skin-injector.js" "$APP_DIR/Contents/Resources/rate-limit-client.js" "$APP_DIR/Contents/Resources/layout-themes.js" "$APP_DIR/Contents/Resources/target-filter.js" "$APP_DIR/Contents/Resources/package.json" "$APP_DIR/Contents/Info.plist"
